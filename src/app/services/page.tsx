      ...
      <main className="min-h-[300px] w-full bg-[#f5f3ff] flex flex-col items-center justify-start pt-12 relative overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-7xl flex flex-col items-center">
          ...
          <section className="mt-16 w-full flex flex-col items-center bg-[#f5f3ff] pt-12 relative ">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 justify-center mb-8 w-full max-w-7xl mt-10">
              {/* SEO Card */}
              <div className="relative rounded-2xl bg-white/60 backdrop-blur-lg shadow-xl flex flex-col items-center p-8 transition-all duration-300 hover:scale-[1.04] hover:shadow-2xl hover:bg-white/80 group border border-[#f63436]/20">
                ...
                <h3 className="text-xl font-bold mb-2 text-center text-[#f63436]">Search Engine Optimization<br/>( SEO )</h3>
                <img src="/file.svg" alt="SEO" className="h-16 mb-4 group-hover:animate-bounce" />
              ...
              <div className="relative rounded-2xl bg-white/60 backdrop-blur-lg shadow-xl flex flex-col items-center p-8 transition-all duration-300 hover:scale-[1.04] hover:shadow-2xl hover:bg-white/80 group border border-[#6c3ee7]/20">
                ...
                <h3 className="text-xl font-bold mb-2 text-center text-[#6c3ee7]">Pay-Per-Click (PPC)<br/>Advertising</h3>
                <img src="/window.svg" alt="PPC" className="h-16 mb-4 group-hover:animate-bounce" />
              ...
              <div className="relative rounded-2xl bg-white/60 backdrop-blur-lg shadow-xl flex flex-col items-center p-8 transition-all duration-300 hover:scale-[1.04] hover:shadow-2xl hover:bg-white/80 group border border-[#fea930]/20">
                ...
                <h3 className="text-xl font-bold mb-2 text-center text-[#fea930]">Social Media Marketing</h3>
                <img src="/globe.svg" alt="Social Media Marketing" className="h-16 mb-4 group-hover:animate-bounce" />
              ...
              <div className="relative rounded-2xl bg-white/60 backdrop-blur-lg shadow-xl flex flex-col items-center p-8 transition-all duration-300 hover:scale-[1.04] hover:shadow-2xl hover:bg-white/80 group border border-[#a7f3d0]/20">
                ...
                <h3 className="text-xl font-bold mb-2 text-center text-[#10b981]">Website Design and<br/>Development</h3>
                <img src="/vercel.svg" alt="Website Design" className="h-16 mb-4 group-hover:animate-bounce" />
            ...
            <a href="#" className="bg-[#6c3ee7] text-white font-semibold px-8 py-3 rounded-full flex items-center gap-2 hover:bg-[#fea930] transition-colors w-fit text-lg shadow-lg mt-5">View More Services <span className="ml-1">↗</span></a>
          </section>

         
             {/* Screenshot-based Team Section */}
            <section className="mt-16 w-full flex flex-col items-center pt-12 relative overflow-hidden">
              {/* Animated gradient background */}
